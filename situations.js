...
// Les cinq passes possibles. L'ordre fixe l'ordre des boutons ET les raccourcis
// clavier 1 à 5.
const PASSES = [
  ...
  { id: 'arriere', label: 'Attaque arrière', label_en: 'Back-row attack', hint: 'derrière la ligne', hint_en: 'behind the line' },
...
const SITUATIONS = [
  {
    ...
    detail: 'Ton central est lancé. Le bloc adverse est encore en train de se replacer.',
    detail_en: 'Your middle is already running. The opposing block is still repositioning.',
  ...
  },
  {
    ...
    detail: "Tu passes en déséquilibre, dos à la moitié du terrain.",
    detail_en: 'You are setting off balance, back to half the court.',
  ...
  },
  {
    ...
    detail: 'Deux contreurs sont partis au milieu. Les ailes sont seules.',
    detail_en: 'Two blockers went to the middle. The wings are alone.',
  ...
  },
  {
    ...
    detail: "Tout le monde t'attend. Ton ailier gauche est fatigué, il a raté ses deux dernières.",
    detail_en: 'Everyone is waiting for you. Your left hitter is tired, he missed his last two.',
  ...
  },
  {
    ...
    detail: "La balle remonte molle. Un seul contreur adverse est remonté à temps.",
    detail_en: 'The ball comes up soft. Only one opposing blocker got back in time.',
  ...
  },
  {
    ...
    detail: "Le public hurle. Ton pointu est en feu ce soir.",
    detail_en: 'The crowd is loud. Your opposite is on fire tonight.',
  ...
  },
  {
    ...
    detail: "Tu cours dos au filet. Tu n'auras pas de deuxième chance.",
    detail_en: 'You are running with your back to the net. No second chance.',
  ...
  },
  {
    ...
    detail: "Il vient de plonger en défense. Le bloc adverse le sait et ne le surveille plus.",
    detail_en: 'He just dove on defence. The block knows it and stopped watching him.',
  ...
  },
  {
    ...
    detail: "Tu as tout le temps du monde. Le bloc aussi.",
    detail_en: 'You have all the time in the world. So does the block.',
  ...
  },
  {
    ...
    detail: "Réception correcte. Il est marqué par le meilleur contreur adverse.",
    detail_en: 'Decent reception. He is covered by their best blocker.',
  ...
  },
  {
    ...
    detail: "Il a sauté sur tes six dernières passes, même les hautes.",
    detail_en: 'He jumped on your last six sets, even the high ones.',
  ...
  },
  {
    ...
    detail: "Personne ne sait encore comment tu distribues. Le bloc est neutre.",
    detail_en: 'Nobody knows how you distribute yet. The block is neutral.',
...
// Export CommonJS pour un futur serveur ; ignoré dans le navigateur.
